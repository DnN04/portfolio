...
//           </nav>
//         </div> */}
//         {/* Fixed header group (logo + nav aligned) */}
// <div className="fixed top-8 left-4 z-50 flex items-center gap-8">
//   {/* Logo */}
//   <a
//     href="/"
//     className="h-[25px] opacity-90 hover:opacity-100 transition-opacity duration-200 flex items-center"
//     aria-label="Home"
//   >
//     <img
//       src="/logo.png"
...
//   {/* Nav */}
//   <nav className="group flex items-center gap-8 text-xs uppercase tracking-wider font-medium">
//     <Link
//       to="/work"
//       className="text-foreground/60 transition-colors duration-200 group-hover:text-foreground hover:text-foreground"
//     >
//       Work
//     </Link>
//     <Link
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      {/* Add Sidebar (same as other pages) */}
      <Sidebar />
      
      {/* Main content shifted right to accommodate sidebar */}
      <main className="ml-16 md:ml-20">
        {/* Keep blur transition */}
        <div className={`${showIntro ? "filter blur-sm" : "transition-all duration-500"} px-6 md:px-12`}>
          <Hero hideNavText introDelay={0} />
        </div>
      </main>
