...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <div>
        {/* logo placeholder at extreme top-left for future logo */}
        <div className="fixed top-4 left-4 z-50 w-10 h-10 opacity-40 hover:opacity-100 transition-opacity duration-200 flex items-center justify-center" aria-hidden>
          {/* leave empty for future logo */}
        </div>

        {/* nav container: dim by default, light up on hover, aligned with hero text below */}
        <div className="fixed top-8 left-5 sm:left-6 md:left-8 z-50 group">
